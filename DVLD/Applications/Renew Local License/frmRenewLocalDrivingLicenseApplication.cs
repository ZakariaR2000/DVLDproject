...
namespace DVLD.Applications.Renew_Local_License
{
    public partial class frmRenewLocalDrivingLicenseApplication : Form
    {
        ...
        private void frmRenewLocalDrivingLicenseApplication_Load(object sender, EventArgs e)
        {
            ...
            lblApplicationID.Text = clsFormat.DateToShort(DateTime.Now);

            lblIssueDate.Text = lblApplicationID.Text;

            lblExpirationDate.Text = "???";

            lblApplicationFees.Text =
                clsApplicationType.Find((int)clsApplication.enApplicationType.RenewDrivingLicense).Fees.ToString();
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            lblOldLicneseID.Text = SelectedLicenseID.ToString();
        ...
        private void btnRenewLicense_Click(object sender, EventArgs e)
        {
            ...
            lblRenewwdLicneseID.Text = _NewLicenseID.ToString();
