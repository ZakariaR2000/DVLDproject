...
namespace DVLD.Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        private void _LoadLocalLicneseInfo()
        {
        ...
        {
            //_dtDriverInternationalLicensesHistory =
            //    clsDriver.GetInternationalLicenses(_DriverID);
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There is no driver linked Perons  id = " + PersonID.ToString());
                return;
            }
